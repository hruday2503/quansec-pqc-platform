...
At login the server sets two cookies:
    ...
    quanseq_refresh   HttpOnly  — the token itself, unreadable by script
    quanseq_csrf      readable  — a random value, deliberately NOT HttpOnly
...
logger = logging.getLogger("quanseq.auth.csrf")
