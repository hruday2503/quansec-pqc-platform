...
SOCKET_PATH = os.environ.get("QUANSEQ_CONTROL_SOCKET", "/run/quanseq/policy.sock")
SWANCTL_CONFIG = pathlib.Path(os.environ.get("QUANSEQ_SWANCTL_CONFIG", "/etc/quanseq-strongswan/swanctl/swanctl.conf"))
SWANCTL_BIN = os.environ.get(
    "QUANSEQ_SWANCTL_BIN", "/opt/quanseq-pqc/sbin/swanctl"
)

PQC_SSHD_CONFIG = pathlib.Path(os.environ.get("QUANSEQ_PQC_SSHD_CONFIG", "/opt/openssh-pqc/etc/sshd_config"))
PQC_SSHD_BIN = os.environ.get("QUANSEQ_PQC_SSHD_BIN", "/opt/openssh-pqc/sbin/sshd")
PQC_SSHD_SERVICE = os.environ.get("QUANSEQ_PQC_SSHD_SERVICE", "quanseq-pqc-sshd.service")
