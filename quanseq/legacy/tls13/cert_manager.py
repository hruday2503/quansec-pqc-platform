...
#
# QUANSEQ PATCH 7: Linux-only guidance; generated private keys are chmod 600.
#
# Certificate generation is reachable from the CLI only
# (quanseq/scripts/generate_tls_certs.py). It is deliberately not exposed
...
class CertManager:
    ...
    Usage:
        cm = CertManager(cert_dir="/home/me/quanseq-certs")
    ...
    def generate_ca(self) -> None:
        ...
        self._run([
            ...
            "-out",  self.ca_cert,
            "-days", str(self.days),
            "-subj", "/C=IN/O=QUANSEQ/CN=QUANSEQ TLS Development Root CA",
        ])
...
""")
    ...
    def _ensure_dir(self) -> None:
        """
        QUANSEQ PATCH 7: create the output directory before writing into it.
    ...
    def _write_temp(self, content: str) -> str:
        ...
        fd, path = tempfile.mkstemp(suffix=".cnf", prefix="quanseq_tls_")
