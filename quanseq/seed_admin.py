"""Securely create or explicitly reset the initial QUANSEQ administrator."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create the initial QUANSEQ administrator."
    )
    parser.add_argument(
        "--email",
        default=os.getenv("ADMIN_EMAIL", "admin@quanseq.io"),
