...
curl https://api.quanseq.io/api/ssh/stats \\
  -H "Authorization: Bearer $QUANSEQ_API_KEY"

# List active SSH connections and their KEX
curl https://api.quanseq.io/api/ssh/connections \\
  -H "Authorization: Bearer $QUANSEQ_API_KEY"`,
  },
  connect: {
    label: "Connect (PQC SSH)",
    code: `# Connect to a QUANSEQ-protected host using hybrid ML-KEM-768
...
KEY = os.environ["QUANSEQ_API_KEY"]
BASE = "https://api.quanseq.io"
