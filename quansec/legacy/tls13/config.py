...
class TLSConfig:
    ...
    In QUANSEC this is built from validated environment settings by
    ...
    # QUANSEC PATCH 4: cap per-connection handshake time so a stalled client
    # cannot occupy a worker indefinitely.
    handshake_timeout: float = 5.0
    max_concurrent_handshakes: int = 8

    # QUANSEC PATCH 1/6: application payloads are never logged unless this is
