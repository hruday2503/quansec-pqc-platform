...
QUANSEC's relationship to NGINX here is the same as its relationship to
...
logger = logging.getLogger("quansec.tls.service")
...
"""
    ...
    return f"""# QUANSEC post-quantum TLS data plane — GENERATED FILE, DO NOT EDIT
#
...
{_LOG_FORMAT}
    ...
    server {{
        ...
        access_log {access_log} quansec_tls;
...
{mtls_block}
        ...
        # single QUANSEC endpoint that echoes the TLS facts NGINX observed.
        location /dataplane/ {{
