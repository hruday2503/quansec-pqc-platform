"""
protocols/tls/policies.py — the named TLS policies QUANSEC can apply.
...
class TlsPolicyDefinition:
    ...
    # May this policy be applied when QUANSEC_ENV=production?
...
CLASSICAL_LAB = TlsPolicyDefinition(
    ...
    warnings=[
        ...
        "measured comparison and is refused when QUANSEC_ENV=production.",
    ],
)
