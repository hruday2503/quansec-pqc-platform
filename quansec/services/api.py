"""Stateless QUANSEC HTTP API. Collectors and policy execution live elsewhere."""
...
app = FastAPI(title="QUANSEC API", version="2.1.0", lifespan=lifespan)
app.add_middleware(
    CORSMiddleware,
...
@app.get("/")
async def root():
    return {"service": "QUANSEC API", "version": "2.1.0", "docs": "/docs"}
