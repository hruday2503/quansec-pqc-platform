...
This is the ONLY way to generate certificates in QUANSEC. There is deliberately
...
The default directory comes from QUANSEC_TLS_CERT_DIR, which should point
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate the QUANSEC TLS development PKI",
    ...
    parser.add_argument(
        ...
        help="output directory (default: QUANSEC_TLS_CERT_DIR = %(default)s)",
    )
    parser.add_argument(
...
def main() -> int:
    ...
    print(f"  QUANSEC_TLS_CERT_DIR={cert_dir}")
    return 0
